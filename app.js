...
var requirePlumbus = require('./plumbus');
const protoPlumbus = requirePlumbus.singletonPlumbus().get();
...
console.assert((protoEyeholes.pvp + protoTurbulentJuice.pvp + protoPlumbus.pvp) == 155);
console.log("Precio pedido: " + (protoEyeholes.pvp + protoTurbulentJuice.pvp + protoPlumbus.pvp));
